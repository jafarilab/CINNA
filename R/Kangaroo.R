#' @title Kangaroo Network
#'
#' @description An undirected graph based on interactions between free-ranging grey kangaroos.
...
#' @references Kangaroo network dataset -- KONECT, October 2016.
#'
